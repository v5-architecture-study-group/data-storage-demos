...
public class FixedTransactionTest {
    ...
    @Test
    public void two_simultaneous_threads_cannot_overdraft_the_account() throws Exception {
        var account = accountService.createAccount("my bank account");
        ...
        assertThat(accountService.getBalance(account)).isEqualTo(new Money(50));
    }
}
